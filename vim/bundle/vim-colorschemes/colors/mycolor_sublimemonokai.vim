...
let colors_name = 'mycolor_sublimemonokai'
...
" Syntax error and warning schemes
call s:h('Warning',      { 'fg': s:red,         'bg': s:black,    'format': 'underline'    })
call s:h('Rare',         { 'bg': s:warmgrey                                                })
...
"call s:h('SyntasticWarningSign',    { 'fg': s:lightblack, 'bg': s:black })
...
" Ycm
hi! link SpellBad SyntasticErrorSign 
hi! link SpellCap SyntasticWarningSign 
hi! link SpellRare Rare
